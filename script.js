(function(){
  ...
  function lootManifest(){if(lootManifestCacheVersion===lootManifestVersion)return lootManifestCache;lootManifestCache=Object.values(lootBag).sort((a,b)=>{let ad=gearDefinition(a),bd=gearDefinition(b);return LOOT_RARITIES[bd.rarity].rank-LOOT_RARITIES[ad.rarity].rank||b.level-a.level||gearScore(b)-gearScore(a)});lootManifestCacheVersion=lootManifestVersion;return lootManifestCache}
