(function(){
  ...
  const SET_DEFINITIONS=[
    ...
    {id:'stormrunner',name:'STORMCALLER',rarity:'epic',minLevel:4,color:'#1e4e63',accent:'#9ed9e5',mark:'\u21AF',focus:['speed','dash'],bonus:{2:{speed:.045},3:{dash:.06},5:{fire:.055,speed:.04}}},
