(function(){
  ...
  function releaseHammerStrike(strike){
    ...
    let waveRadius=strike.explosive?MELEE.shockwaveRadius:strike.shockwave?MELEE.shockwaveRadius+28:116;physicalShockwave(impactX,impactY,waveRadius,damage*(strike.explosive?.5:.28),strike.thermal?'#c83f46':strike.color,MELEE.impactRadius*.7,{mode:'none'});
  ...
  function fireAt(target){
    ...
    pendingStrikes.push({delay:.075,nx,ny,count,explosive,thermal,banner,starfall,forceCritical,crit:stats.crit,critEcho:stats.critEcho,moonArc:signature.moonbreaker,shockwave,damage:shotDamage()*stats.damage*damageBoost,color:hammerColor});return true
  }
