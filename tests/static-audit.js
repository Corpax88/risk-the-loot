...
assert(html.includes('ADVENTURE BAG')&&html.includes('animeBagShell')&&html.includes('gearCategoryRail')&&html.includes('unifiedEquipmentWorkspace')&&html.includes('equipmentOrbitSlots')&&css.includes('Unified Equipment UI'),'unified Adventure Bag presentation is missing');
