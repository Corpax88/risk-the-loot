...
assert(script.includes("assets/black-hole-hammer-idle-v1.png")&&script.includes("assets/black-hole-hammer-run-v1.png")&&script.includes("assets/black-hole-hammer-attack-v1.png")&&script.includes("assets/black-hole-vortex-spawn-v2.png")&&script.includes("assets/black-hole-vortex-idle-v2.png")&&script.includes("assets/black-hole-vortex-pull-v2.png")&&script.includes("assets/black-hole-vortex-pulse-v2.png")&&script.includes("assets/black-hole-vortex-dash-v2.png")&&script.includes("assets/black-hole-vortex-collapse-v2.png")&&script.includes("assets/black-hole-vortex-burst-v2.png")&&css.includes("assets/black-hole-gear-icons-v1.png")&&script.includes("assets/black-hole-gear-drops-v1.png"),'production Black Hole Hammer presentation is not wired');
...
assert(css.includes("assets/lava-gear-icons-v1.png")&&script.includes("assets/lava-gear-drops-v1.png")&&script.includes("assets/lava-hammer-idle-v1.png")&&script.includes("assets/lava-hammer-run-v1.png")&&script.includes("assets/lava-hammer-attack-v1.png")&&script.includes("assets/handlava-hit-splash-v1.png")&&script.includes("for(const phase of ['idle','extend','grab','swing','throw','retract'])")&&script.includes("loadImage('assets/handlava-'+phase+'-v1.png')"),'Lava Set transformation, gear, splash, or Handlava phase assets are not wired');
...
assert(css.includes("assets/nature-gear-icons-v1.png")&&script.includes("assets/nature-gear-drops-v1.png")&&script.includes("assets/nature-hammer-idle-v1.png")&&script.includes("assets/nature-hammer-run-v1.png")&&script.includes("assets/nature-hammer-attack-v1.png")&&script.includes("assets/ancient-ent-v1.png")&&script.includes("assets/nature-root-trap-v1.png"),'Nature Set transformation, gear, Ancient Ent, or Rootwhip assets are not wired');
...
assert(script.includes('gear-drops-atlas.png')&&script.includes('set-gear-drops.png')&&script.includes('legendary-gear-drops.png')&&script.includes('SET_GEAR_ROW')&&script.includes('LEGENDARY_SET_ROW')&&script.includes('drawAdventureLootSprite')&&css.includes("background-image:url('assets/gear-items-atlas.png')")&&css.includes("background-image:url('assets/set-gear-atlas.png')")&&css.includes("background-image:url('assets/legendary-gear-atlas.png')")&&css.includes("assets/stormcaller-gear-icons-v1.png"),'sprite-atlas item identities are missing');
