...
assert(script.includes('pappaHammerImage')&&script.includes('buildPappaHammerAtlas')&&script.includes('drawEquipmentCharacterFrame')&&script.includes("assets/pappa-hammer-player.png?v=20260804-v1-foundation"),'approved Pappa Hammer V1 master is not wired');
...
assert(script.includes('SAVE_VERSION=15')&&script.includes('if(raw.version!==SAVE_VERSION)raw={}')&&script.includes('materials:0,legendaryCores:0')&&script.includes('gear:[]')&&script.includes('level:1,xp:0')&&script.includes('equipped:emptyEquipment()'),'Pappa V1 development reset or progression model is missing');
