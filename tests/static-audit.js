...
assert(script.includes("assets/black-hole-hammer-idle-v1.png")&&script.includes("assets/black-hole-hammer-run-v1.png")&&script.includes("assets/black-hole-hammer-attack-v1.png")&&script.includes("assets/black-hole-vortex-spawn-v2.png")&&script.includes("assets/black-hole-vortex-idle-v2.png")&&script.includes("assets/black-hole-vortex-pull-v2.png")&&script.includes("assets/black-hole-vortex-pulse-v2.png")&&script.includes("assets/black-hole-vortex-dash-v2.png")&&script.includes("assets/black-hole-vortex-collapse-v2.png")&&script.includes("assets/black-hole-vortex-burst-v2.png")&&script.includes("path:'assets/black-hole-gear-icons-v1.png'"),'production Black Hole Hammer presentation is not wired');
...
assert(script.includes("path:'assets/nature-gear-icons-v1.png'")&&script.includes("assets/nature-hammer-idle-v1.png")&&script.includes("assets/nature-hammer-run-v1.png")&&script.includes("assets/nature-hammer-attack-v1.png")&&script.includes("assets/ancient-ent-v1.png")&&script.includes("assets/nature-root-trap-v1.png"),'Nature Set transformation, gear, Ancient Ent, or Rootwhip assets are not wired');
