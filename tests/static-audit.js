...
assert(script.includes("assets/lava-gear-icons-v1.png")&&script.includes("assets/lava-gear-drops-v1.png")&&script.includes("for(const phase of ['idle','extend','grab','swing','throw','retract'])")&&script.includes("loadImage('assets/handlava-'+phase+'-v1.png')"),'Lava Set gear or Handlava phase assets are not wired');
