...
assert(script.includes('const productionGearAtlases=Object.freeze({})')&&script.includes('const ACTIVE_SET_DEFINITIONS=Object.freeze([])')&&script.includes('const LOOT_ITEMS=Object.freeze([])')&&script.includes('const ARCHIVED_GEAR_ITEMS=Object.freeze(')&&script.includes('PAPPA_V1_FOUNDATION'),'Pappa V1 clean gear foundation is not isolated from legacy production gear');
