...
assert(html.includes('style.css?v=0.12.0')&&html.includes('script.js?v=0.12.0'),'release assets are not versioned');
for(const asset of ['pappa-hammer-player.png','pappa-hammer-idle-v2.png','pappa-hammer-run-v2.png','pappa-hammer-attack-v2.png','pappa-hammer-workshop.png','pappa-hammer-enemies.png','pappa-hammer-bosses.png'])assert(fs.existsSync('assets/'+asset),'Pappa Hammer asset is missing: '+asset);
