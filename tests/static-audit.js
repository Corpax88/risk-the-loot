...
assert(script.includes('pappaHammerImage')&&script.includes('buildPappaHammerAtlas')&&script.includes('drawEquipmentCharacterFrame')&&script.includes("assets/pappa-hammer-player.png?v=20260803-modular"),'corrected modular Pappa Hammer base is not wired');
...
assert(script.includes("assets/black-hole-vortex-spawn-v2.png")&&script.includes("assets/black-hole-vortex-idle-v2.png")&&script.includes("assets/black-hole-vortex-pull-v2.png")&&script.includes("assets/black-hole-vortex-pulse-v2.png")&&script.includes("assets/black-hole-vortex-dash-v2.png")&&script.includes("assets/black-hole-vortex-collapse-v2.png")&&script.includes("assets/black-hole-vortex-burst-v2.png")&&script.includes("path:'assets/black-hole-gear-icons-v1.png'"),'production Black Hole Hammer presentation is not wired');
...
assert(script.includes("path:'assets/lava-gear-icons-v1.png'")&&script.includes("assets/handlava-hit-splash-v1.png")&&script.includes("for(const phase of ['idle','extend','grab','swing','throw','retract'])")&&script.includes("loadImage('assets/handlava-'+phase+'-v1.png')"),'Lava Set gear, splash, or Handlava phase assets are not wired');
...
assert(script.includes("path:'assets/nature-gear-icons-v1.png'")&&script.includes("assets/ancient-ent-v1.png")&&script.includes("assets/nature-root-trap-v1.png"),'Nature Set gear, Ancient Ent, or Rootwhip assets are not wired');
...
assert(script.includes("SAVE_VERSION=14")&&script.includes('raw.version!==13')&&script.includes('materials:0,legendaryCores:0')&&script.includes('gear:[]')&&script.includes('level:1,xp:0')&&script.includes('equipped:emptyEquipment()'),'Level 100 save migration, unique gear, or progression model is missing');
...
assert(script.includes('const productionGearAtlases=')&&script.includes("path:'assets/gear-items-atlas.png'")&&script.includes("path:'assets/legendary-gear-atlas.png'")&&script.includes("path:'assets/stormcaller-gear-icons-v1.png'")&&script.includes('SET_GEAR_SOURCE_IDS')&&script.includes('drawProductionGearAsset')&&script.includes('drawAdventureLootSprite'),'production gear asset identities are missing');
