...
assert(html.includes('id="gearLockerButton"')&&html.includes('id="gearGrid"')&&html.includes('class="gearCharacterHero domLayeredFigure"')&&['cape','baseBody','legs','boots','chest','scarf','hat','weapon','fullFigure'].every(layer=>html.includes('data-character-layer="'+layer+'"'))&&script.includes('function refreshArmoryCharacterLayers'),'Gear Locker or canonical layered character preview is missing');
