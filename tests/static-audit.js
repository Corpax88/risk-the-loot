...
assert(script.includes("assets/black-hole-hammer-idle-v1.png")&&script.includes("assets/black-hole-hammer-run-v1.png")&&script.includes("assets/black-hole-hammer-attack-v1.png")&&script.includes("assets/black-hole-hammer-vfx-v1.png")&&script.includes("assets/black-hole-gear-icons-v1.png")&&script.includes("assets/black-hole-gear-drops-v1.png"),'production Black Hole Hammer presentation is not wired');
