...
assert(html.includes('data-help-title="Gear Comparison"')&&html.includes('data-help-title="Risk or Extract"')&&html.includes('data-help-title="Destination Progress"')&&script.includes('data-help-title="Hammer Damage"'),'important progression, loot and loadout explanations are missing');
